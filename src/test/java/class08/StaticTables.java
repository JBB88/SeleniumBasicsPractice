    ...
    public static void main(String[] args) {
        ...
        for (WebElement col:column){
            ...
            if (col.getText().equals("in progress")){
                System.out.println(count); // print the row number
                // find particular row
                WebElement row=driver.findElement(By.xpath("//table[@id='task-table']/tbody/tr[" + count + "]")); // don't hard code the row number
                System.out.println(row.getText());
            }
